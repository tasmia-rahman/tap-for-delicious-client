  ...
  return (
    <div className="my-44 mx-10">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-col-1 gap-10 mx-auto px-5 mt-10">
        {/* first part */}
        <div>
          <div className="card bg-base-100 shadow-xl mx-auto hover:scale-105 duration-500 ">
          ...
          <div className="card bg-base-100 shadow-xl mx-auto hover:scale-105 duration-500  mt-10">
            <div className="flex p-4 ">
              <TiTickOutline className="text-6xl my-auto text-yellow-400 border-4 rounded-full"></TiTickOutline>
              <h2 className="card-title ml-2 ">
        ...
        <div className="hidden hover:scale-105 duration-500 lg:block my-auto">
          <img
            style={{ height: 490 }}
