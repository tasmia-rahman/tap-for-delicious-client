...
const TopRestaurantCard = ({ restaurant }) => {
  const { img, title, type, time, location, email } = restaurant;
      ...
      <div className="card w-full lg:max-w-96 h-[500px] mx-auto bg-base-100 shadow-xl">
        ...
        <div className="card-body">
          ...
          <div className="card-actions justify-end ">
            ...
            <Link to={`/resDetails/${email}`}>  <button className='btn border-2 border-amber-400 text-amber-500 rounded-2xl hover:bg-amber-400 bg-transparent hover:text-white hover:border-amber-400 text'>more Details </button></Link>
