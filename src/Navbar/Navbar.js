                ...
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <li className='cursor-pointer'>
                            {dark ? <div onClick={handleTheme} className=""  ><MdOutlineLightMode /></div> :
                                <div onClick={handleTheme} className=""> <MdOutlineDarkMode /></div>
                            }
                        </li>
                        ...
                        <li className='text-lg font-medium text-amber-500 hover:text-amber-300'><Link to='/cart'><FaCartArrowDown className='border-0 hover:border-2 py-1 px-2 rounded-xl hover:border-amber-400 text-5xl text-amber-400
